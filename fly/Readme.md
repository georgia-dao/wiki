...
### Проблемы
 * объявлено, что российские компании до 8 марта должны закрыть международные рейсы, есть риск, что отберут самолёты, которые в лизинге
