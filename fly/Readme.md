 ...
 * ВСЕ РОССИЙСКИЕ компании до 8 марта должны закрыть международные рейсы, есть риск, что отберут самолёты, которые в лизинге
 * но может не все. У некоторых ак есть супер джеты которые вроде как под лизинг точно не попадают (список?!)
 * АЗИМУТ — есть рейс с пересадкой в Краснодаре, но аэропорт Краснодара закрыт, но закрытие постоянно продлевается. Возможно, авиакомпания сделает пересадку в Мин. Водах (единственный работающий в том регионе аэропорт), а возможно просто вернёт деньги;
 * turkishairlines — держим пальцы, что всё будет хорошо, и им не закроют небо. Рейсы через Стамбул с одной пересадкой.
 * армянские авиалинии — летают, пока не летает россия
